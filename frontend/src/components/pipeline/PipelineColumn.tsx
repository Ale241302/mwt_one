  ...
  return (
    <div className="flex flex-col w-64 min-w-[256px]">
      ...
      <div className="flex items-center justify-between mb-2 px-1">
        <span className="text-xs font-semibold uppercase tracking-[0.5px] text-slate-500">{label}</span>
      ...
      <div className="flex flex-col gap-2 flex-1 overflow-y-auto">
        {cards.length === 0 ? (
          <div className="text-xs text-slate-300 text-center py-8 border border-dashed border-slate-200 rounded-xl">
            Sin expedientes
          </div>
        ) : (

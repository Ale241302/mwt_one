...
urlpatterns = [
    # ── Node CRUD ──────────────────────────────────────────────────────────────
    path("nodes/",                       views.list_nodes_view,   name="nodes_list"),
    path("nodes/create/",                views.create_node_view,  name="nodes_create"),
    path("nodes/<uuid:node_id>/",        views.update_node_view,  name="nodes_update"),
    path("nodes/<uuid:node_id>/delete/", views.delete_node_view,  name="nodes_delete"),

    # ── Transfer CRUD (S10-02a) ────────────────────────────────────────────────
    path("",                                          views.list_transfers_view,               name="list"),
    path("create/",                                   views.create_transfer_view,              name="create"),
    path("<str:transfer_id>/edit/",                   views.update_transfer_view,              name="update"),
    path("<str:transfer_id>/delete/",                 views.delete_transfer_view,              name="delete"),

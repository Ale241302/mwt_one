...
class TestAvailableCommands:
    ...
    def test_commands_estado_registro(self):
        """test_commands_estado_registro() → [C2, C3, C4, C15, C17] disponibles"""
    ...
    def test_commands_estado_produccion(self):
        """test_commands_estado_produccion()  → [C6, C15, C17/C18]"""
    ...
    def test_commands_estado_preparacion(self):
        """test_commands_estado_preparacion() → [C7, C8, C9, C10, C15]"""
    ...
    def test_commands_estado_despacho(self):
        """test_commands_estado_despacho()    → [C11, C15, C17/C18]"""
    ...
    def test_commands_estado_recepcion(self):
        """test_commands_estado_recepcion()   → [C12, C15, C17/C18]"""
    ...
    def test_commands_estado_facturacion(self):
        """test_commands_estado_facturacion() → [C13, C21, C14, C15]"""
    ...
    def test_commands_estado_cerrado(self):
        """test_commands_estado_cerrado()     → [] vacío (solo lectura)"""
    ...
    def test_commands_estado_cancelado(self):
        """test_commands_estado_cancelado()   → [] vacío"""
